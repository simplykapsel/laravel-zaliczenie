    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
                <svg src="/public/" class="bi me-2" width="40" height="32" role="img" aria-label="Bootstrap">
                ...
                <div class="text-end">
                    @auth
                        @if(Auth::user()->role=='admin')
                            <a href="{{ url('/admin') }}" class="btn btn-outline-light me-2">Profil</a>
                        @elseif(Auth::user()->role=='user')
                            <a href="{{ url('/user') }}" class="btn btn-outline-light me-2">Profil</a>
                        @endif
                    @else
