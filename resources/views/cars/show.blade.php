            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="number" min="1900" max="2021" value="{{$car->rok}}" class="form-control" name="rok"
                               placeholder="Rok" autocomplete="rok" disabled>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="rodzaj" name="rodzaj" autocomplete="rodzaj" disabled>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="skrzynia" name="skrzynia" autocomplete="skrzynia"
                                disabled>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="naped" name="naped" autocomplete="naped" disabled>
