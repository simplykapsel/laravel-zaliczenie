...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{__('Edytuj uzytkownika')}}</div>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text"
                                           ...
                                           value="{{ $users->surname }}" required autocomplete="surname" autofocus>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                           ...
                                           value="{{ $users->password }}" required autocomplete="password" autofocus>
                            ...
                            <div class="form-group-row">
                                ...
                                <div class="col-md-6">
                                    <input list="role"
                                           ...
                                           value="{{ $users->role }}" list="listarole" required autocomplete="role" autofocus pattern="admin|user">
                                    <datalist id="role">
                                        <option>admin</option>
                                        <option>user</option>
                                    </datalist>
